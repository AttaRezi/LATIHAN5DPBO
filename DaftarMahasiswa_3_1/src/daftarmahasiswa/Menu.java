...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        // Constructor
        initComponents(); //buat ngeload komponen yg didesign
        listMhs = new ArrayList<>();
        
        // Dummy
        listMhs.add(new Mahasiswa("2132888", "Cahya Gumilang", "Laki-Laki", "A"));
        listMhs.add(new Mahasiswa("2001103", "Nelly Joy C. S.", "Perempuan", "B"));
        listMhs.add(new Mahasiswa("2202222", "Muhammad Satria R.", "Laki-Laki", "C"));
    ...
    public void insertData() {
        ...
        if(nim.equals("") || nama.equals("") || nilai.equals("")){
           ...
           // Add New Data
           listMhs.add(new Mahasiswa(nim, nama, gender, nilai));
    ...
    public void cancel() {
        ...
        fieldNim.setText("");
        fieldNama.setText("");
        fieldGender.setSelectedItem("-Pilih Jenis Kelamin-");
        fieldNilai.setText("");
    }
    ...
    private void initComponents() {
        ...
        fieldGender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-Pilih Jenis Kelamin-", "Laki-Laki", "Perempuan" }));
